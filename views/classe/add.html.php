<div class="card border-light my-3 w-75 shadow   " style="height:80%" >
  <div class="card-header bg-transparent border-light bg-header">Nouvelle Classe</div>
    <div class="card-body ">
     ...
     <form action="<?=WEB_URL?>/classe-add" method="post">
         <div class="mb-3">
         ...
         <div class="mb-3">
           ...
           <input type="text" class="form-control <?=isset($errors['libelle'])?"is-invalid":""  ?>" name="libelle" id="" aria-describedby="helpId" placeholder="">
