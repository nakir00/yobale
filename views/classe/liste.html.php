<div class="card border-light my-3 w-75 shadow   " >
  <div class="card-header bg-transparent border-light bg-header">Liste des Classes</div>
    <div class="card-body ">
            ...
            <?php foreach($classes as $value):?>
                <tr>
                    ...
                    <td  style="width:45%">
                        ...
                        <a name="" id="" class="btn btn-outline-info text-dark btn-xs" href="<?=WEB_URL?>/etudiant" role="button">Etudiants</a>
                    </td>
                </tr>
            <?php endforeach?>
            </tbody>
