...
class Cours extends Model{
    ...
    public function insert(){
        $sql="INSERT INTO  ".parent::table()."  (`dateCours`,`heureDebut`,`heureFin`,classe_id,module_id,professeur_id) VALUES (?,?,?,1,1,1)";
     ...
     $sql="UPDATE ".parent::table()." SET `dateCours` = ?, `heureDebut` = ?, `heureFin` = ? WHERE `cours`.`id` = ? ";
     return parent::database()->executeUpdate($sql,[
         $this->dateCours,
         $this->heureDebut,
         $this->heureFin,
